...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SetLocation = __webpack_require__(167);

	var _SetLocation2 = _interopRequireDefault(_SetLocation);

	var _LocationList = __webpack_require__(168);
	...
	var App = function (_Component) {
	  ...
	  _createClass(App, [{
	    key: 'setLocation',
	    value: function setLocation(name) {
	      this.setState({
	        autoId: this.state.autoId + 1,
	        todos: [].concat(_toConsumableArray(this.state.locations), [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_SetLocation2.default, { onSubmit: this.setLocation }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Location = __webpack_require__(169);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Location = function Location(props) {
	  ...
	  return _react2.default.createElement(
	    ...
	    'props.longitude, props.latitude & props.status'
	  );
	};
